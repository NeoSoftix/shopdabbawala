    ...
    <div className="bg-white rounded-[24px] border border-gray-100 p-6 shadow-[0_10px_30px_rgba(0,0,0,0.02)]">
      <div className="flex items-center justify-between gap-3 mb-5 pb-5 border-b border-gray-100">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-full bg-red-50 text-[#e61e2d] px-4 py-2 text-xs font-bold hover:bg-red-100 transition-colors shrink-0"
        >
      ...
      <UserProfileEdit isOpen={isEditOpen} onClose={() => setIsEditOpen(false)} />
    </div>
  );
};
