 ...
 */
export default function ModalShell({ isOpen, onClose, wide, showCloseButton, children }) {
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className={`relative bg-white w-full rounded-3xl shadow-2xl border border-slate-100 overflow-hidden z-10 flex flex-col max-h-[90vh] ${wide ? "max-w-4xl" : "max-w-md"
              }`}
          >
