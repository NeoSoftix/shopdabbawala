  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 antialiased">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl shadow-slate-100 border border-slate-100/50 p-6 md:p-8 relative overflow-hidden flex flex-col items-center text-center">
        ...
        <div className="absolute top-24 left-8 text-red-400 opacity-60 text-xs">
          ♥
        </div>
        <div className="absolute top-6 right-16 w-2 h-2 bg-red-400 rounded-full opacity-60"></div>
        <div className="absolute top-14 right-8 w-4 h-4 text-red-300 opacity-50 select-none">
          ★
        </div>
        <div className="absolute top-28 right-12 text-red-400 opacity-60 text-sm">
          ♥
        </div>
        ...
        <div className="w-24 h-24 bg-gradient-to-b from-red-50 to-white rounded-full flex items-center justify-center border border-red-100 shadow-inner mb-6 relative">
          <div className="w-20 h-20 rounded-full border border-red-50 flex items-center justify-center">
            <svg
              className="w-10 h-10 text-red-600 stroke-[3.5]"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
        ...
        {/* Header Text */}
        <h1 className="text-3xl md:text-4xl font-serif font-bold text-red-600 mb-3 tracking-wide">
          Thank You!
        </h1>
        ...
        {/* Small decorative heart divider */}
